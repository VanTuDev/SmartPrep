         ...
         <nav className="flex space-x-8">
            <div className="py-4 relative">
               <NavLink
                  ...
                  className={({ isActive }) =>
                     isActive ? 'text-purple-700 font-medium font-extrabold' : 'text-gray-600 hover:text-purple-700 transition-all duration-200'
                  }
               >
                  Bản tin
               </NavLink>
