      ...
      <div className="container mx-auto px-6 lg:px-8">
        <nav className="flex items-center justify-between">
          ...
          <div className="hidden md:flex space-x-4">
            <Button type="primary" className="text-white bg-blue-600 hover:bg-blue-700">
              Đăng ký
            </Button>
            <Button className="border-blue-600 text-blue-600 hover:border-blue-700 hover:text-blue-700">
              Đăng nhập
            </Button>
          </div>
        ...
        {isMobileMenuOpen && (
          <ul className="md:hidden bg-white shadow-lg rounded-lg p-4 space-y-4">
            ...
            <div className="flex justify-between px-4 py-4">
              <Button type="primary" className="w-full mr-2 hover:bg-blue-700 transition">
                Đăng ký
              </Button>
              <Button className="w-full ml-2 text-blue-600 border-blue-600 hover:border-blue-700 hover:text-blue-700 transition">
                Đăng nhập
              </Button>
            </div>
          </ul>
